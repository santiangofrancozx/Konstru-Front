...
function PlusIcon(props) {
    return (
      <svg
        {...props}
        xmlns="http://www.w3.org/2000/svg"
        width="200"  // Aumenté el tamaño del icono
        height="200" // Aumenté el tamaño del icono
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
                ...
                <div className="grid gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">Construction Budget Manager</p>
                    </div>
                  </div>
                  <Separator />
                  <div className="grid gap-2">
